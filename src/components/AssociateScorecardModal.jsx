      ...
      {!loading && data && (
        <>
          ...
          <div className="flex items-center gap-3 mb-4">
            <Avatar name={data.associate.name} color={data.associate.color} photoUrl={data.associate.photoUrl} photoZoom={data.associate.photoZoom} photoPosX={data.associate.photoPosX} photoPosY={data.associate.photoPosY} size={44} />
