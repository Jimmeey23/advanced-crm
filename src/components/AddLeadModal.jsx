      ...
      <form onSubmit={submit} className="space-y-3.5">
        <div className="grid grid-cols-2 gap-3">
          <div className="col-span-2">
            <label className="text-[11.5px] font-semibold text-slate-400 mb-1 block">Full name *</label>
            <input className="input" value={form.fullName} onChange={set('fullName')} placeholder="e.g. Aisha Khan" autoFocus />
          </div>
          <div>
            <label className="text-[11.5px] font-semibold text-slate-400 mb-1 block">Phone</label>
            <input className="input" value={form.phone} onChange={set('phone')} placeholder="91…" />
          </div>
          <div>
            <label className="text-[11.5px] font-semibold text-slate-400 mb-1 block">Email</label>
            <input className="input" value={form.email} onChange={set('email')} placeholder="name@email.com" />
          </div>
          <div>
            <label className="text-[11.5px] font-semibold text-slate-400 mb-1 block">Studio location</label>
          ...
          <div>
            <label className="text-[11.5px] font-semibold text-slate-400 mb-1 block">Lead source</label>
            <select className="input" value={form.sourceName} onChange={set('sourceName')}>
              {(boot?.sources || []).map(s => <option key={s}>{s}</option>)}
            </select>
          </div>
          <div>
            <label className="text-[11.5px] font-semibold text-slate-400 mb-1 block">Class interest</label>
          ...
          <div>
            <label className="text-[11.5px] font-semibold text-slate-400 mb-1 block">Stage</label>
        ...
        <div>
          <label className="text-[11.5px] font-semibold text-slate-400 mb-1 block">Notes / remarks</label>
