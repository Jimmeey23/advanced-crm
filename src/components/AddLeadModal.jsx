    ...
    <Modal open={open} onClose={onClose}>
      ...
      <form onSubmit={submit} className="space-y-3.5">
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            <label className="text-xs font-semibold text-slate-500 mb-1 block">Studio location</label>
          ...
          <div>
            <label className="text-xs font-semibold text-slate-500 mb-1 block">Lead source</label>
            <select className="input" value={form.sourceName} onChange={set('sourceName')}>
              {(boot?.sources || []).map(s => <option key={s}>{s}</option>)}
            </select>
          </div>
          <div>
            <label className="text-xs font-semibold text-slate-500 mb-1 block">Class interest</label>
        ...
        <div>
          <label className="text-xs font-semibold text-slate-500 mb-1 block">Notes / remarks</label>
